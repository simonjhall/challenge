/*=============================================================================
Copyright © 2007 Broadcom Europe Limited.
...
#define OMX_BRCM_MAXIOPERFBANDS 4
typedef struct OMX_CONFIG_BRCMIOPERFSTATSTYPE {
   OMX_U32 nSize;
   OMX_VERSIONTYPE nVersion;
   OMX_BOOL bEnabled;                              /**< Enable/disable I/O performance statistics */
   OMX_U32 nIOBandLimit[OMX_BRCM_MAXIOPERFBANDS];  /**< Band upper limit (in Mb/s, e.g. 5 or 25)  */
   OMX_U32 nIOBandValue[OMX_BRCM_MAXIOPERFBANDS];  /**< I/O measured at this band (number of bytes, cumulative) */
...
typedef enum OMX_CONFIG_CAMERAALGORITHMTYPE {
   ...
   OMX_CameraAlgorithmCustomColour,
